...
void UObject::appScreenDebugMessageStatic ( struct FString sMsg )
{
	static UFunction* pFnappScreenDebugMessageStatic = NULL;

	if ( ! pFnappScreenDebugMessageStatic )
		pFnappScreenDebugMessageStatic = UObject::FindObject< UFunction > ( "Function Core.Object.appScreenDebugMessageStatic" );
...
// Parameters infos:
// struct TArray<class UObject*>  ReturnValue                    ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
// class UClass*                  SearchClass                    ( CPF_Parm )
// unsigned long                  SearchChildren                 ( CPF_OptionalParm | CPF_Parm )
// class UObject*                 ResultOuter                    ( CPF_OptionalParm | CPF_Parm )
// struct TArray<class UObject*>  out_ObjectResults              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )

struct TArray<class UObject*> UObject::GetObjectArrayFromConfigSection ( class UClass* SearchClass, unsigned long SearchChildren, class UObject* ResultOuter, struct TArray<class UObject*>* out_ObjectResults )
{
	static UFunction* pFnGetObjectArrayFromConfigSection = NULL;

	if ( ! pFnGetObjectArrayFromConfigSection )
		pFnGetObjectArrayFromConfigSection = UObject::FindObject< UFunction > ( "Function Core.Object.GetObjectArrayFromConfigSection" );
