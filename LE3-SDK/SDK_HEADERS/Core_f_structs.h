...
struct UObject_execGetObjectArrayFromConfigSection_Parms
{
	...
	struct TArray<class UObject*>                      out_ObjectResults;                                		// 0x0008 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	...
	struct TArray<class UObject*>                      ReturnValue;                                      		// 0x0024 (0x0010) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
};
...
{
	class UClass*                                      SearchClass;                                      		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	struct TArray<struct FString>                      out_SectionNames;                                 		// 0x0008 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
...
struct UObject_execGetEnumIndex_Parms
{
	...
	struct FName                                       valueName;                                        		// 0x0008 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
struct UObject_execParseLocalizedPropertyPath_Parms
{
	...
	// struct TArray<struct FString>                   Pieces;                                           		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct UObject_execSplitString_Parms
{
	...
	struct TArray<struct FString>                      ReturnValue;                                      		// 0x0024 (0x0010) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// struct TArray<struct FString>                   Result;                                           		// 0x0034 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct UObject_execParseStringIntoArray_Parms
{
	...
	struct TArray<struct FString>                      Pieces;                                           		// 0x0010 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
...
{
	struct TArray<struct FString>                      StringArray;                                      		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
struct UObject_execGetTokenisedString_Parms
{
	...
	struct TArray<struct FSFXTokenMapping>             TokenList;                                        		// 0x0004 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     ReturnValue;                                      		// 0x0014 (0x0010) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
};
...
struct UObject_execSetCustomToken_Parms
{
	...
	struct FString                                     sToken;                                           		// 0x0004 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
